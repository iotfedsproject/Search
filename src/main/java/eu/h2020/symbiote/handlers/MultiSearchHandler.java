...
//                ResultSet results = this.triplestore.executeQueryOnUnionGraph(q.toString(), request.getSecurityRequest(), false);
                ResultSet results = this.triplestore.executeQueryOnGraph(q.toString(), TripleStore.UNION_GRAPH, request.getSecurityRequest(), true /*was false*/);
...
private String runSparqlQuery( SparqlQueryResponse response ) {
    ...
    log.debug("Running sparql query with useSecureGraph = true");
    log.debug("Running sparql query calling executeQueryOnUnionGraph() method");
...
//----------------------------------------------------------------------------------------------------------------------------------
        private String xrunSparqlQuery( SparqlQueryResponse response ) {
            String resultOfSearch = null;

            log.debug("1 Running sparql query with useSecureGraph = true");
            ResultSet resultSet = this.triplestore.executeQueryOnUnionGraph(request.getBody(), request.getSecurityRequest(), true /*was false*/);//was executeQuery
            ByteArrayOutputStream stream = new ByteArrayOutputStream();
            ...
            log.debug("1 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");

            //////////////////////////////////////////////////////////////////////
             //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("2 Running sparql query with useSecureGraph = true");
            resultSet = this.triplestore.executeQueryOnGraph(request.getBody(),"http://www.symbiote-h2020.eu/ontology/internal/models/*", request.getSecurityRequest(), true /*was false*/);

            stream = new ByteArrayOutputStream();

            formatString  = request.getOutputFormat().toString();
            log.debug("formatString = " + formatString);

            format = ResultsFormat.lookup(formatString);
            try {
                ResultSetFormatter.output(stream, resultSet, format);
            } catch (ARQException e) {
                log.warn("Got unsupported format exception, switching to text output format... " + e.getMessage());
            ...
            log.debug("2 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");


            //////////////////////////////////////////////////////////////////////
            //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("3 Running sparql query with useSecureGraph = true");
            resultSet = this.triplestore.executeQueryOnDataset(QueryFactory.create(request.getBody(), Syntax.syntaxARQ), request.getSecurityRequest(), true /*was false*/);
            ...
            log.debug("3 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");

            //////////////////////////////////////////////////////////////////////
            //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("4 Running sparql query with useSecureGraph = true");
            resultSet = this.triplestore.executeQueryOnUnionGraph(request.getBody(), request.getSecurityRequest(), true /*was false*/);
            ...
            log.debug("4 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");


            //////////////////////////////////////////////////////////////////////
            //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("5 Running sparql query with useSecureGraph = true");
            resultSet = this.triplestore. executeQueryOnGraph(request.getBody(), "http://www.symbiote-h2020.eu/ontology/internal/models/*",request.getSecurityRequest(), true /*was false*/);
            ...
            log.debug("5 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");

           /////////////----------------------------------------------//////////////

            log.debug("6 Running sparql query with useSecureGraph = false");
            resultSet = this.triplestore.executeQuery(request.getBody(), request.getSecurityRequest(), false);
            ...
            log.debug("6 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");

            //////////////////////////////////////////////////////////////////////
            //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("7 Running sparql query with useSecureGraph = false");
            resultSet = this.triplestore.executeQueryOnGraph(request.getBody(),"http://www.symbiote-h2020.eu/ontology/internal/models/*", request.getSecurityRequest(), false);
            ...
            log.debug("7 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");


            //////////////////////////////////////////////////////////////////////
            //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("8 Running sparql query with useSecureGraph = false");
            resultSet = this.triplestore.executeQueryOnDataset(QueryFactory.create(request.getBody(), Syntax.syntaxARQ), request.getSecurityRequest(), false);
            ...
            log.debug("8 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");

            //////////////////////////////////////////////////////////////////////
            //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("9 Running sparql query with useSecureGraph = true");
            resultSet = this.triplestore.executeQueryOnUnionGraph(request.getBody(), request.getSecurityRequest(),  false);
            ...
            log.debug("9 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");


            //////////////////////////////////////////////////////////////////////
            //QueryFactory.create(queryString, Syntax.syntaxARQ)
            log.debug("10 Running sparql query with useSecureGraph = false");
            resultSet = this.triplestore. executeQueryOnGraph(request.getBody(), "http://www.symbiote-h2020.eu/ontology/internal/models/*",request.getSecurityRequest(),  false);
            ...
            log.debug("10 Got response from sparql query: " + StringUtils.substring(resultOfSearch,0,10000) + " ....");
